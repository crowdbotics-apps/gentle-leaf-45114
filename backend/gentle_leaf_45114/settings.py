"""
Django settings for gentle_leaf_45114 project.
...
ROOT_URLCONF = 'gentle_leaf_45114.urls'
...
WSGI_APPLICATION = 'gentle_leaf_45114.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gentle_leaf_45114 API",
    "DESCRIPTION": "API documentation for gentle_leaf_45114 App",
    "VERSION": "v1",
}
